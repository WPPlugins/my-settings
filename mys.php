...
?>
	...
	<tr>
	<td class="left"></td>
	<td class="left" colspan="2"><span class="description"> Change Login URL for custom login page and Redirect URL for redirect after login.</span></td>
	</tr>
	</tbody>
	</table>
	...
	<td align="left"><input type="hidden" name="action" value="update" /> 
					<input type="hidden" name="page_options" value="mys_email_from, mys_email_sender, mys_login_url, mys_login_rurl, mys_hide_theme_edt, mys_hide_plugin_edt, mys_show_tag, mys_show_tag_all, mys_before_tag, mys_after_tag, mys_show_to_admin, mys_hide_bar, mys_footer, mys_show_tag_page" /></td>
...
if(get_option('mys_show_tag') == 'show' || get_option('mys_show_tag_all') == 'show'){
	...
	add_action( 'deactivate_' . WC_PLUGIN_BASENAME  , 'mys_delete_plugin' );
